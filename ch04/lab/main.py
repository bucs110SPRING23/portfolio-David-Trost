...
for round_num in range(1, 11):
    ...
    dart_x = random.randrange(0, screen.get_width())
    dart_y = random.randrange(0, screen.get_height())
    ...
    dart_on_board_x = dart_x - dartboard_center[0] + screen.get_width() // 2
    dart_on_board_y = dart_y - dartboard_center[1] + screen.get_height() // 2
